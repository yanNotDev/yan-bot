    ...
    @cog_ext.cog_slash(
        ...
        options=[
            create_option(
                ...
                True,
            choices=[
                create_choice(name="mining speed", value="mining_speed"),
                create_choice(name="mining fortune", value="mining_fortune"),
                create_choice(name="quick forge", value="quick_forge"),
                create_choice(
                    name="titanium insanium", value="titanium_insanium"
                ),
                create_choice(name="daily powder", value="daily_powder"),
                create_choice(name="luck of the cave", value="luck_of_the_cave"),
                create_choice(name="crystallized", value="crystallized"),
                create_choice(name="effecient miner", value="effecient_miner"),
                create_choice(name="orbiter", value="orbiter"),
                create_choice(name="seasoned mineman", value="seasoned_mineman"),
                create_choice(name="mole", value="mole"),
                create_choice(name="professional", value="professional"),
                create_choice(name="lonesome miner", value="lonesome_miner"),
                create_choice(name="great explorer", value="great_explorer"),
                create_choice(name="fortunate", value="fortunate"),
                create_choice(name="powder buff", value="powder_buff"),
                create_choice(name="mining speed two", value="mining_speed_two"),
                create_choice(
                    name="mining fortune two", value="mining_fortune_two"
                ),
            ],
            ),
